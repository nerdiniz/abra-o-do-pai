            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h2 className="font-serif text-3xl font-bold text-stone-800 dark:text-stone-100 flex items-center gap-3">
                        <MessageSquare className="text-gold-500" /> Auxílio Espiritual
                    </h2>
                    <p className="text-stone-500 dark:text-stone-400 mt-1 italic">Estamos aqui para caminhar com você na fé.</p>
                </div>
                ...
                <div className="flex bg-stone-100 dark:bg-stone-900 p-1 rounded-2xl border border-stone-200 dark:border-stone-800">
                    <button
                        ...
                        className={`px-6 py-2 rounded-xl text-xs font-bold transition-all ${activeTab === 'request'
